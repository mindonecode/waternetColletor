...
public class DbManager {
	...
	// sql 세션
	private static SqlSession _sqlSession_oracle = null;
	...
	public static void startReconnectThreadTiberoSudo() {
		final ScheduledThreadPoolExecutor executor = new ScheduledThreadPoolExecutor(1);
		// 1분 주기
		executor.scheduleAtFixedRate(new TiberoSudoReconnectThread(), 0, ConstDef.db_reconn_time_ms, TimeUnit.MILLISECONDS);
	}
