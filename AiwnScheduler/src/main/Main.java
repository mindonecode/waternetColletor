...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		if (initLog() == true) {
			...
			if (loadConfigFile() == true) {
				...
				executor.scheduleAtFixedRate(new TiberoSudoDBRunProcessThread(), 0, ConstDef.prcs_heartbeat_tims_ms,
						TimeUnit.MILLISECONDS);
				executor.scheduleAtFixedRate(new TiberoDBRunProcessThread(), 0, ConstDef.prcs_heartbeat_tims_ms,
						TimeUnit.MILLISECONDS);
	...
	private static boolean initLog() throws UnknownHostException {
		...
		String logConfFile = ConstDef.LOG_CONF_PATH;
